    ...
    <div class="row">
      <div class="col-md-7">
        <div class="page-header"> <!-- page header  -->
          <h1><?php the_title() ?></h1>
          <?php 
          $insurance_sub = get_post_meta(get_the_ID(),'_cmb_insurance_sub', true); 
          ?>
          <p class="lead"><?php echo esc_attr($insurance_sub); ?></p>
      ...
      <div class="col-md-5 header-pic">
        <div class="img-responsive">
            ...
            <?php $images = rwmb_meta( '_cmb_image_insurance', "type=image" ); ?>
            <?php if($images){ ?>         
            <?php                                                        
